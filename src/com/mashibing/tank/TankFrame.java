...
import com.mashibing.abstractFactory.*;
...
//    BaseTank myTank = gf.createTank(100,200,Dir.DOWN,this,Group.GOOD);
    public List<BaseBuild> builds = new ArrayList<BaseBuild>();
